...
class PromiseCreateInstruction : public Instruction {
  public:
    explicit PromiseCreateInstruction(const promise_id_t id,
    ...
    static PromiseCreateInstruction parse_arguments(const char *begin,
                                                    char **end);
