...
class EnvironmentVariableAssignInstruction
    : public EnvironmentVariableActionInstruction {

  public:
    explicit EnvironmentVariableAssignInstruction(const environment_id_t id,
    ...
    static EnvironmentVariableAssignInstruction
